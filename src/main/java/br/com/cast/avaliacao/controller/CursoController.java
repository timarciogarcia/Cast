...
public class CursoController {
	 ...
	 * 
	 * @PutMapping(value = "/{id}") public ResponseEntity<CursoDto>
	 * update(@PathVariable Integer id, @RequestBody CursoDto objDto){ Curso newObj
	 * = cursoService.update(id,objDto); return ResponseEntity.ok().body(new
	 * CursoDto(newObj)); }
	 * 
